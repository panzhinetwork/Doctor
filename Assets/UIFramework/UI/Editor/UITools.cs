...
namespace UIFramework.Editor {
    ...
    public static class UITools {
        ...
        [MenuItem("Assets/Create/Fancy UI/UI Pack Prefab", priority = 1)]
        ...
        [MenuItem("GameObject/Fancy UI/UI Pack in Scene", priority = 1)]
        public static void CreateUIPackInScene() {
            CreateUIPack();
        }

        [MenuItem("GameObject/Fancy UI/UI Devolop Layer", priority = 2)]
        public static void CreateUIDevolopEnvironment() {
            ...
            // Create UILayer
            var layer = UILayer.CreateLayerGameObject(root.transform, UILayerType.Normal, cam, UISettings.DefaultResolution);
        ...
        private static UIViewPresenter CreateUILayerManager(Transform parent, int uiLayer, Camera uiCamera) {
            ...
            var layerArray = UIViewPresenter.CreateAllLayerGameObjects(go.transform, uiCamera, UISettings.DefaultResolution);
